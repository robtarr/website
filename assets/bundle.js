...
/***/ function(module, exports, __webpack_require__) {
	...
	let ReactDOM = __webpack_require__(159);
	let Twitter = __webpack_require__(160);
	let Github = __webpack_require__(162);
	let Blog = __webpack_require__(163);
	let Books = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const ps = __webpack_require__(161);

	const Twitter = React.createClass({
	  displayName: 'TwitterReact',

	  componentDidMount: function() {
	    ps.subscribe('message-twitter', function(data)  {
	      this.setState(data);
	    }.bind(this));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  componentDidMount: function() {
	    ps.subscribe('message-github', function(data)  {
	      this.setState(data);
	    }.bind(this));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  componentDidMount: function() {
	    ps.subscribe('message-blog', function(data)  {
	      this.setState(data);
	    }.bind(this));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  componentDidMount: function() {
	    ps.subscribe('message-books', function(data)  {
	      this.setState(data);
	    }.bind(this));
	  },
	  ...
	  render: function() {
	    let $__0=       this.state,title=$__0.title,link=$__0.link,author=$__0.author,authorLink=$__0.authorLink;

	    return (
	      React.createElement("div", null, 
	        React.createElement("svg", {className: "icon icon-books recentList-item-icon", viewBox: "0 0 39 44"}, 
	          React.createElement("path", {d: "M35.75,5.5 L35.75,41.25 L6.875,41.25 C4.59525,41.25 2.75,39.402 2.75,37.125 C2.75,34.848 4.59525,33 6.875,33 L33,33 L33,0 L5.5,0 C2.475,0 0,2.475 0,5.5 L0,38.5 C0,41.525 2.475,44 5.5,44 L38.5,44 L38.5,5.5 L35.75,5.5 L35.75,5.5 L35.75,5.5 Z"}), 
	          React.createElement("path", {d: "M6.87775,35.75 L6.87775,35.75 L6.875,35.75 C6.116,35.75 5.5,36.366 5.5,37.125 C5.5,37.884 6.116,38.5 6.875,38.5 L6.87775,38.5 L6.87775,38.5 L32.99725,38.5 L32.99725,35.75 L6.87775,35.75 L6.87775,35.75 L6.87775,35.75 Z"})
	        ), 

	        React.createElement("h1", {className: "recentList-item-heading"}, "What I’m Reading"), 
	        React.createElement("a", {className: "recentList-item-primaryLink recentList-item-externalLink", href:  link }, 
	           title 
	        ), 
	        React.createElement("article", null, 
	          React.createElement("div", {className: "recentList-item-detail"}, 
	            React.createElement("p", null, 
	              ...
	              React.createElement("a", {className: "recentList-item-externalLink", href:  authorLink }, 
	                 author 
	              )
	            )
	          )
